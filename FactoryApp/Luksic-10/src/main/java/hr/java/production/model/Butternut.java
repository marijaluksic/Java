...
/**
 * sluzi za stvaranje objekta tipa Butternut koja nasljeduje klasu Item i implementira sucelje Edible
 */
public class Butternut extends Item implements Edible, Serializable {
    /**
     * sprema masu artikla
     */
     ...
     */
    private static final int KILOCALORIES_PER_KG = 450;

    /**
     * sluzi za stvaranje objekta tipa Butternut
     ...
     */
    public Butternut(Long id, String name, BigDecimal width, BigDecimal height, BigDecimal length, BigDecimal productionCost,
                     BigDecimal sellingPrice, BigDecimal weight, Discount discount) {
        super(id, name, new Category(1L, Edible.class.getSimpleName(),"Category of edible items"), width, height,
    ...
    public boolean equals(Object o) {
        ...
        hr.java.production.model.Butternut butternut = (hr.java.production.model.Butternut) o;
        return Objects.equals(weight, butternut.weight);
    }
